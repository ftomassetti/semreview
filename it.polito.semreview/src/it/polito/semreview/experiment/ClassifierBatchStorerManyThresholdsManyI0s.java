...
public class ClassifierBatchStorerManyThresholdsManyI0s {
	...
	public static void main(String[] args) throws IOException, LoadingException {
		...
		execute(plainPapersDir, enrichedDir, i0Files, csvInterestingPapers, args[4]);
	}

	public static void execute(File plainPapersDir, File enrichedDir,
			Collection<File> i0Files, File csvInterestingPapers, String resultBasePath)
		...
		List<Pair<PaperId, String>> papersToExamine = instance
				.loadAllEnriched();
